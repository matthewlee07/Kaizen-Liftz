...
workout.regiments.build([
    ...
    { exercise_id: 2,  sets: 5,  reps: 5 , weight: 135 },
    { exercise_id: 3, sets: 5,  reps: 5 , weight: 135 }
])
workout.save!
# replace:
# Workout.create!([
...
WorkoutEntry.create!(
    { workout_id: 1, start_time: "2019-06-21 15:00:00", stop_time: "2019-06-21 16:00:00", comments: "Was too tired to try for last set." }
)

# ExerciseEntry.create!([
#     { workout_entry_id: 2, exercise_id: 1, sets: 6, reps: 5, weight: 65, comments: "Felt light, try 105 pounds next" }, 
#     { workout_entry_id: 2, exercise_id: 2, sets: 6, reps: 5, weight: 135, comments: "Felt light, try 205 pounds next" }, 
#     { workout_entry_id: 2, exercise_id: 3, sets: 6, reps: 5, weight: 135, comments: "Felt comfortable, but worried about form. Try 155 pounds next" }
#     ]
# )


# ExerciseEntry.create!([
#     { workout_entry_id: 3, exercise_id: 1, sets: 6, reps: 5, weight: 65, comments: "Felt light, try 105 pounds next" }, 
#     { workout_entry_id: 3, exercise_id: 2, sets: 6, reps: 5, weight: 135, comments: "Felt light, try 205 pounds next" }, 
#     { workout_entry_id: 3, exercise_id: 3, sets: 6, reps: 5, weight: 135, comments: "Felt comfortable, but worried about form. Try 155 pounds next" }
#     ]
# )